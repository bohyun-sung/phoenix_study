defmodule Contexts.CMSTest do
  use Contexts.DataCase

  alias Contexts.CMS

  describe "pages" do
    alias Contexts.CMS.Page

    @valid_attrs %{"": 42, body: "some body", title: "some title", views: "some views"}
    @update_attrs %{"": 43, body: "some updated body", title: "some updated title", views: "some updated views"}
    @invalid_attrs %{"": nil, body: nil, title: nil, views: nil}
